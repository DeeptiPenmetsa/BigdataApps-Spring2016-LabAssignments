...
import java.io.*;
 ...
 import java.util.Random;
        ...
        /**
 17  * Created by Mayanka on 25-Oct-15.
 18  */
         ...
         public static void main(String args[]) {
                 ...
                 try {
                       ...
                       String[] classes = {"books", "keys"};
                        ...
                        for (int i = 0; i < classes.length; i++) {
                                 File folder = new File("newdata/training/" + classes[i]);
                         ...
                         classify(instances,new File("newdata/testing/keys/key11.wav"));
               ...
               double[] samples = audio.getSamplesMixedDown();
                ...
                public static void sendToAndroid(String message) throws IOException {
                BufferedReader inFromUser = new BufferedReader(new InputStreamReader(System.in));
                Socket clientSocket = new Socket("192.168.1.135", 1234);
               ...
               FastVector attValsRel = new FastVector();
                ...
                //Classifying the test data with the train data
                   for (int i = 0; i < test.numInstances(); i++) {
                        ...
                        sendToAndroid("The file you heard, " + file.getName() + ", is a " + test.classAttribute().value((int) pred));
